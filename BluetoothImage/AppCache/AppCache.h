...
#import "ImageBlock.h"
//static NSMutableDictionary *BlockReceivedTable;
//static NSMutableDictionary *BlockSendedTable;
...
@property NSMutableDictionary *FileCapacity;

//获取AppCache单例
+(AppCache *)shareManager;

//imageBlock是一个分块，接受完一个分块后调用该方法
-(void)storeData:(ImageBlock *)imageBlock;
...
//在应用程序接受的时候调用，把BlockReceivedTable、BlockSendedTable、FileCapacity和Sender储存到硬盘，下次打开应用的时候再把他们加载进内存
-(void)storeBaseData;
...
//获取接受某个文件的百分比
-(NSString *)getPercentageWithReceivingFileName:(NSString *)fileName;
